                        ...
                        <div class="col-md-5 text-end">
                            <ul class="topbar-right">
                                ...
                                <li class="login-register">
                                    ...
                                    @if(Auth::user()->email == 'henrikkroko@gmail.com')
            ...
            $("#setPinModal").on('click', '.pin-description-save', function(){
                $.ajax({
                    ...
                    'success' : function(data) {  
                        @if(Auth::user())
                            pins.push({name: 'marker_'+(posLat*posLng), posLat: posLat, posLng: posLng, description: $("#pinDescription").val(), status:$("#setStatus").val(), user_id: {{Auth::user()->id}}, user: {name: '{{Auth::user()->name}}'}});
                            console.log(pins);
                            initMap();
                        @endif
                    },
